...
// SVG //
import SvgLogoW from "./svg/LogoW";
        ...
        <>
          <div className="container mx-auto px-2 sm:px-6 lg:px-8">
            ...
            <div className="relative flex items-center justify-center justify-between h-32">
              ...
              <Link to="/">    
                <SvgLogoW className="block h-8 w-auto fill-current stroke-current text-white "/>
               </Link>
              </div>
              ...
              <div className="flex items-center  md:flex-wrap">
                <a href="https://www.linkedin.com/in/olivier-pierre-01085319/" target='_blank' rel='noreferrer noopener'>    
                  <SvgLinkedin className="block h-8  w-auto  fill-current stroke-current text-white "/>
                </a>
                
                <a href="https://github.com/OlivPi" target='_blank' rel='noreferrer noopener'>    
                  <SvgGithub className="block h-8 w-auto fill-current stroke-current text-white "/>
                </a>
